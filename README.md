...
2. Fill in at least `JWT_SECRET`, `DATABASE_URL`, Google OAuth values, and `OPENROUTER_API_KEY` (parcel extraction from Gmail — see roadmap F-06). Optional `OPENROUTER_MODEL` overrides the default `openai/gpt-5.4-nano`.
